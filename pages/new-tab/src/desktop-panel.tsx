...
export function DesktopPanel() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-400 via-purple-400 to-blue-400 p-8">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          ...
          <FeatureCard
            ...
            description="Get deep insights of your network performance with advanced analytics and machine learning."
            icon={
          ...
          <FeatureCard
            title="Detect"
            description="Comes with the best-in-industry fraud detection system to protect your business."
            icon={
          ...
          <FeatureCard
            title="Scale"
            description="With OfferHub Cloud, just pay for what you use. Scale up or down as needed."
            icon={
          ...
          <FeatureCard
            title="Integrate"
            description="Easy integration with popular platforms and tools you already use daily."
            icon={
