...
export function ChromeExtensionApp() {
  return (
    <div className="w-[420px] h-[600px] bg-gradient-to-br from-indigo-400 via-purple-400 to-blue-400 p-6 overflow-auto">
      <div className="grid grid-cols-2 gap-4 h-full">
        ...
        <div className="col-span-2">
          <FeatureCard
            title="Scale"
            description="With OfferHub Cloud, just pay for what you use."
            icon={
