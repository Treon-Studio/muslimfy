...
class SDKCore {
  ...
  writeToFolder(jsonStr, dir, key, extraConfig, index) {
    ...
    const sharding = compressData ? new import_build.File.FileSharding(import_common.Algorithm.compressText(jsonStr)) : new import_build.File.FileSharding(jsonStr);
