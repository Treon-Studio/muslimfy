...
function getSourceRangeFromTransformedOffset(module2, node) {
  ...
  if (import_common.Lodash.isUndefined(sourceRange?.start.line) || import_common.Lodash.isUndefined(sourceRange?.start.column) || import_common.Lodash.isUndefined(sourceRange?.end?.line) || import_common.Lodash.isUndefined(sourceRange?.end?.column)) {
    return transformedReport;
  }
  return {
    path: module2.path,
