...
async function loop(options, value, devUrls) {
    const [{ select, selectKey, isCancel, cancel }, { default: showQRCode }] = await Promise.all([
        __webpack_require__.e("167").then(__webpack_require__.bind(__webpack_require__, "../../../node_modules/.pnpm/@clack+prompts@0.10.1/node_modules/@clack/prompts/dist/index.mjs")),
        Promise.all([
            __webpack_require__.e("167"),
            __webpack_require__.e("640"),
            __webpack_require__.e("204")
