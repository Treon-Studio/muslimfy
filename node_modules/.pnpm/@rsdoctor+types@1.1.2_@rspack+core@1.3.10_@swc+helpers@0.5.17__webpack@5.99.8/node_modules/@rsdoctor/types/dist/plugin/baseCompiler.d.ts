import type { Compiler, Compilation, Stats, StatsError, RuleSetRule, Asset } from 'webpack';
import type { Compiler as RspackCompiler, Compilation as RspackCompilation, Stats as RspackStats, RuleSetRule as RspackRuleSetRule, MultiCompiler, Assets as RspackAssets } from '@rspack/core';
...
type updateAsset = (file: string, newSourceOrFunction: (arg0: Asset['source'] | RspackAssets['source']) => Asset['source'] | RspackAssets['source'], assetInfoUpdateOrFunction?: (arg0?: any) => any) => void;
