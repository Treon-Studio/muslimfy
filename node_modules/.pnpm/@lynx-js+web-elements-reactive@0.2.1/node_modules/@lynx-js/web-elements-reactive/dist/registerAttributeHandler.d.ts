 ...
 * @returns
 */
export declare const registerAttributeHandler: (key: string, args_0: boolean) => <T>(this: T, target: AttributeChangeHandler | undefined, context: ClassMemberDecoratorContext | ClassFieldDecoratorContext<T, unknown>) => any;
